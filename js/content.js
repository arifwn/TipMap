(function( root ) {
  ...
  var injectPopup = mp.injectPopup = function (query) {
    ...
    var iframe = createElementFromHTML('<div class="mp_popup_container" style="position: fixed; top: 0; left: 0; width: 100%; height: 100%; z-index: 99999999999999; pointer-events: none;">' +
